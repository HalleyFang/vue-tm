...
export default {
  ...
  methods: {
    drawColumnChart() {
      axios.get('/api/drawColumnChart').then(
          (resp) => {
            this.drawColumnChartData = resp.data;
          }
      )
    ...
    drawScatterChart() {
      ...
      axios.get('/api/drawScatterChart').then(
          (resp) => {
            this.chartScatterData = resp.data;
          }
      )
      ...
      /*let mydata = {
        "counties": ["China", "United States", "United Kingdom", "Russia", "India",
          "France", "Germany", "Australia", "Canada", "Cuba", "Finland", "Iceland",
          "Japan", "North Korea", "South Korea", "New Zealand", "Norway", "Poland", "Turkey"],
        "timeline": [1800, 1810, 1820, 1830, 1840, 1850, 1860, 1870, 1880, 1890, 1900,
          1910, 1920, 1930, 1940, 1950, 1951, 1952, 1953, 1954, 1955, 1956, 1957, 1958,
          1959, 1960, 1961, 1962, 1963, 1964, 1965, 1966, 1967, 1968, 1969, 1970, 1971,
          1972, 1973, 1974, 1975, 1976, 1977, 1978, 1979, 1980, 1981, 1982, 1983, 1984,
          1985, 1986, 1987, 1988, 1989, 1990, 1991, 1992, 1993, 1994, 1995, 1996, 1997,
          1998, 1999, 2000, 2001, 2002, 2003, 2004, 2005, 2006, 2007, 2008, 2009, 2010,
          2011, 2012, 2013, 2014, 2015],
        "series": [[[815, 34.05, 351014, "Australia", 1800],
      ...
      let schema = [
        ...
        {name: 'caseId', index: 0, text: '用例ID', unit: ''},
        {name: 'execTime', index: 2, text: '执行时长', unit: 's'},
      ...
      option = {
        baseOption: {
          ...
          title: [{
            text: this.chartScatterData.timeline[0],
            textAlign: 'right',
            left: '80%',
            top: '10%',
            textStyle: {
          ...
          visualMap: [
            {
              show: false,
              dimension: 3,
              categories: this.chartScatterData.counties,
              inRange: {
                color: (function () {
          ...
          series: [
            {
              type: 'scatter',
              itemStyle: itemStyle,
              data: this.chartScatterData.series[0],
      ...
      for (let n = 0; n < this.chartScatterData.timeline.length; n++) {
        option.baseOption.timeline.data.push(this.chartScatterData.timeline[n]);
        option.options.push({
          title: {
            show: true,
            'text': this.chartScatterData.timeline[n] + ''
          },
          series: {
            name: this.chartScatterData.timeline[n],
            type: 'scatter',
            itemStyle: itemStyle,
            data: this.chartScatterData.series[n],
            symbolSize: function (val) {
              return sizeFunction(val[2]);
            }
          }
